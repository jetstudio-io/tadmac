 ...
 */
void XMacLayer::handleUpperMsg(cMessage *msg)
{
 ...
 * back to sleep.
 */
void XMacLayer::handleSelfMsg(cMessage *msg)
{
	switch (macState)
	{
	case INIT:
 ...
 */
void XMacLayer::handleLowerMsg(cMessage *msg)
{
 ...
 * packet itself.
 */
void XMacLayer::handleLowerControl(cMessage *msg)
{
...
void XMacLayer::attachSignal(macpkt_ptr_t macPkt)
{
...
void XMacLayer::changeDisplayColor(BMAC_COLORS color)
{
	if (!animation)
		return;
...
/*void XMacLayer::changeMacState(States newState)
{
	switch (macState)
	{
	case RX:
